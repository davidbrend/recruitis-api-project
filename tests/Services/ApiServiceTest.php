...
class ApiServiceTest extends TestCase
{
     ...
     */
    public function testGetJobsDataPayload(): void
    {
        ...
        $stream->expects($this->once())
            ->method('getContents')
            ->willReturn($this->getTestingData());
    ...
    public function testGetJobsData(): void
    {
        ...
        $this->assertIsArray($data);
        $this->assertEquals('test', $data['meta']['code']);
        $this->assertEquals('test message', $data['meta']['message']);
     ...
     * @throws \JsonException
     */
    public function testGetJobsDataInvalidResponse(): void
    {
        $client = $this->createMock(Client::class);
        $response = $this->createMock(ResponseInterface::class);
        $stream = $this->createMock(StreamInterface::class);
        ...
        $this->expectException(RecruitisApiException::class);
        $this->expectExceptionMessage('Invalid data');

        $apiService = new ApiService($client);
        $apiService->getJobsData();
    }

    /**
     * @throws \JsonException
     */
    private function getTestingData(): bool|string
    {
        return json_encode([
            'payload' => [
                [
